...
captureAgent.start()
    ...
    .then(() => {
        const config = buildScoutConfiguration({
            name: process.env.SCOUT_NAME || "scout-express-v4-demo",
        ...
        app.get("/api/hello", (_req, res) => {
            res.json({ message: "Hello from the internal API!", framework: "express", version: 4 });
        });
        ...
        const server = app.listen(PORT, () => {
            console.log(`Express v4 demo app listening on port ${PORT}`);
        });
