...
Scout also supports [Log Management](https://scoutapm.com/docs/node/log-management) and [Error Monitoring](https://scoutapm.com/docs/node/error-monitoring) (automatic capture of uncaught exceptions and unhandled rejections, plus manual reporting via `captureError`).
