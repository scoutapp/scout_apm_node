...
//         .catch(err => TestUtil.shutdownScout(t, scout, err));
// });
// TODO: since the tests above use the global scout instance
// (by not providing one, one is created in the middle ware)
// we need to stop that global scout instance here, since it's possible that when we make
// a new scout instance, the process will start and immediately become useless
// (since core-agent detects another core-agent running)
...
//         t.equals(
//           internalOpSpan.parent.id,
//           controllerSpan.id,
//           "the internal op span's parent is the controller span",
//           );
//         // Shutdown and close scout
//         TestUtil.shutdownScout(t, scout);
//     };
