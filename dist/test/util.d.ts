...
export declare const PG_TEST_TIMEOUT_MS = 3000;
export declare const MYSQL_TEST_TIMEOUT_MS = 3000;
...
export declare function expressAppWithGETControllerError(middleware: any): Application;
